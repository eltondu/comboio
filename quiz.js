...
var $indicators = $('<ol>')
  ...
  */
  ...
  var $social = $("<div>")
    ...
    .html('<div id = "social-text">Você curtiu este quiz?<br>Compartilhe com seus amigos.<br> Use sempre capacete!<br>Pilote com segurança.</div>')
    .appendTo($results_slide);
...
function resultsText(state) {
  ...
  switch (true) {
    case (ratio === 1):
      text = "Muito bem!<br>Você está pronto para viajar em comboio.<br>Pelo menos os sinais você já sabe.";
      break;
    case (ratio > 0.9):
      text = "Uau! Você conhece bastante sinais. Parabéns!";
      break;
    case (ratio > 0.60):
      text = "Está indo bem, mas essa pontuação ainda está abaixo do esperado.";
      break;
    case (ratio > 0.5):
      text = "Ainda não está bom, mas pelo menos você não errou tudo.";
      break;
    case (ratio < 0.5 && ratio !== 0):
      text = "Parece que você se atrapalhou um pouco com os sinais. Pratique mais!";
      break;
    case (ratio === 0):
      text = "Oh não! Espero que você se saia melhor na próxima vez.";
      break;
  }
  return text;
